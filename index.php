...
<!-- 
                        ...
                        <article class="card">
                            ...
                            <div class="container">
                                <h4>Portfolio: Example Ltd</h4>
                                <p>The Client: Example Ltd Example metal scrapyard is based in West Dereham, Norfolk.
                                    It...
                                </p>
                                <a class="btn" href="#">Read more</a>
                                ...
                                <div class="author">
                                    <div class="avatar">
                                        <img src="img/nm-av.webp" alt="netmatters avatar">
                                    </div>
                                    <div class="details">
                                        <strong>Posted by Netmatters Ltd</strong>
                                        <p>29th September 2020</p>
                                    </div>
                                </div>
                            </div>
                        </article>
                        <article class="card">
                            ...
                            <div class="container">
                                <h4>Securing a Role in The Tech Industry</h4>
                                <p>The tech industry is one of the fastest growing in East Anglia. Technology has an
                                    impact
                                    on...</p>
                                <a class="btn" href="#">Read more</a>
